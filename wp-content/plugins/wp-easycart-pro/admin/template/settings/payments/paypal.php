<div class="ec_admin_paypal_row">
    <div class="ec_admin_slider_row">
        ...
        <h3><?php _e( 'PayPal', 'wp-easycart-pro' ); ?></h3>
        <div class="ec_admin_slider_row_description">
            ...
            <a href="<?php echo wp_easycart_admin( )->available_url; ?>/paypal-v2/production_onboard.php?redirect=<?php echo urlencode( admin_url( ) . '?wpeasycart_paypal_onboard=production' ); ?>"><?php _e( 'Switch Accounts', 'wp-easycart-pro' ); ?></a>
            ...
            <a href="<?php echo wp_easycart_admin( )->available_url; ?>/paypal-v2/sandbox_onboard.php?redirect=<?php echo urlencode( admin_url( ) . '?wpeasycart_paypal_onboard=sandbox' ); ?>"><?php _e( 'Switch Accounts', 'wp-easycart-pro' ); ?></a>
            <?php }?>
