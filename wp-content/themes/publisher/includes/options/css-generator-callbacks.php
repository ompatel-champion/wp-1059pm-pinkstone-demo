...
if ( ! function_exists( 'publisher_cb_css_generator_layout_2_col' ) ) {
	...
	function publisher_cb_css_generator_layout_2_col( &$block = array(), &$value = '' ) {
		...
		$block[1] = array(
			...
			'prop'            =>
				array(
					'max-width' => _publisher_width_changer_to_px( $value['width'] ),
					'width'     => '100%',
				),
		);
		...
		$block[2] = array(
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $value['content'], '%' ),
				),
		);
		...
		$block[3] = array(
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $value['primary'], '%' ),
				),
		);
		...
		$block[4] = array(
			...
			'prop'            =>
				array(
					'left' => _publisher_width_changer_to_px( $value['primary'], '%' ),
				),
		);
		$block[5] = array(
			'before'          => '@media (min-width: 768px){',
			...
			'prop'            =>
				array(
					'left'  => 'inherit',
					'right' => _publisher_width_changer_to_px( $value['primary'], '%' ),
				),
		);
		...
		$block[6] = array(
			...
			'prop'            =>
				array(
					'right' => _publisher_width_changer_to_px( $value['content'], '%' ),
				),
		);
		$block[7] = array(
			'before'          => '@media (min-width: 768px){',
			...
			'prop'            =>
				array(
					'right' => 'inherit',
					'left'  => _publisher_width_changer_to_px( $value['content'], '%' ),
				),
		);
...
if ( ! function_exists( 'publisher_cb_css_generator_layout_3_col' ) ) {
	...
	function publisher_cb_css_generator_layout_3_col( &$block = array(), &$value = '' ) {
		...
		$block[4] = array(
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $value['secondary'], '%' ),
				),
		);
		...
		$block[5] = array(
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $sm_content, '%' ),
				),
		);
		$block[6] = array(
			'before'          => '@media (max-width:1000px) and (min-width:768px){',
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $sm_primary, '%' ),
				),
		);
		...
		$block[7] = array(
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $xs_primary, '%' ),
				),
		);
		$block[8] = array(
			'before'          => '@media (max-width:767px) and (min-width:500px){',
			...
			'prop'            =>
				array(
					'width' => _publisher_width_changer_to_px( $xs_secondary, '%' ),
				),
		);
		...
		$block[9]  = array(
			...
			'prop'            =>
				array(
					'left' => _publisher_width_changer_to_px( $value['secondary'], '%' ),
				),
		);
		$block[10] = array(
			'before'          => '@media (min-width: 1000px){',
			...
			'prop'            =>
				array(
					'left'  => 'inherit',
					'right' => _publisher_width_changer_to_px( $value['secondary'], '%' ),
				),
		);
		$block[11] = array(
			'before'          => '@media (min-width: 1000px){',
		...
		$block[21] = array(
			...
			'prop'            =>
				array(
					'right' => _publisher_width_changer_to_px( $value['content'] + $value['primary'], '%' ),
				),
		);
		$block[22] = array(
			'before'          => '@media (min-width: 1000px){',
			...
			'prop'            =>
				array(
					'right' => 'inherit',
					'left'  => _publisher_width_changer_to_px( $value['content'] + $value['primary'], '%' ),
				),
		);
		...
		$block[23] = array(
			...
			'prop'            =>
				array(
					'left' => _publisher_width_changer_to_px( $value['secondary'] + $value['primary'], '%' ),
				),
		);
		$block[24] = array(
			'before'          => '@media (min-width: 1000px){',
			...
			'prop'            =>
				array(
					'left'  => 'inherit',
					'right' => _publisher_width_changer_to_px( $value['secondary'] + $value['primary'], '%' ),
				),
		);
		$block[25] = array(
			'before'          => '@media (min-width: 1000px){',
		...
		$block[31] = array(
			...
			'prop'            =>
				array(
					'right' => _publisher_width_changer_to_px( $value['content'] - $value['secondary'], '%' ),
				),
		);
		$block[32] = array(
			'before'          => '@media (min-width: 1000px){',
			...
			'prop'            =>
				array(
					'right' => 'inherit',
					'left'  => _publisher_width_changer_to_px( $value['content'] - $value['secondary'], '%' ),
				),
		);
		$block[33] = array(
			'before'          => '@media (min-width: 1000px){',
		...
		$block[35] = array(
			...
			'prop'            =>
				array(
					'left' => _publisher_width_changer_to_px( $sm_primary, '%' ),
				),
		);
		$block[36] = array(
			'before'          => '@media (max-width:1000px) and (min-width:768px){',
			...
			'prop'            =>
				array(
					'left'  => 'inherit',
					'right' => _publisher_width_changer_to_px( $sm_primary, '%' ),
				),
		);
		$block[37] = array(
			'before'          => '@media (max-width:1000px) and (min-width:768px){',
			...
			'prop'            =>
				array(
					'right' => _publisher_width_changer_to_px( $sm_content, '%' ),
				),
		);
		$block[38] = array(
			'before'          => '@media (max-width:1000px) and (min-width:768px){',
			...
			'prop'            =>
				array(
					'right' => 'inherit',
					'left'  => _publisher_width_changer_to_px( $sm_content, '%' ),
				),
...
if ( ! function_exists( 'publisher_cb_css_generator_columns_space' ) ) {
	...
	function publisher_cb_css_generator_columns_space( &$block = array(), &$value = '' ) {
		...
		$block[1] = array(
			...
			'prop'            =>
				array(
					'padding-left'  => _publisher_width_changer_to_px( $columns_padding ),
					'padding-right' => _publisher_width_changer_to_px( $columns_padding ),
				),
		);
		...
		$block[2] = array(
			...
			'prop'            =>
				array(
					'margin-left'  => _publisher_width_changer_to_px( $columns_padding_neg ),
					'margin-right' => _publisher_width_changer_to_px( $columns_padding_neg ),
				),
		);
		...
		$block[18] = array(
			...
			'prop'            =>
				array(
					'margin-left'  => _publisher_width_changer_to_px( $columns_padding_neg, 'px', '!important' ),
					'margin-right' => _publisher_width_changer_to_px( $columns_padding_neg, 'px', '!important' ),
				),
		);
		...
		$block[3] = array(
			...
			'prop'            =>
				array(
					'margin-bottom' => _publisher_width_changer_to_px( $space ),
				),
		);
		...
		$block[4] = array(
			...
			'prop'            =>
				array(
					'margin-bottom' => _publisher_width_changer_to_px( $space_2_6 ),
				),
		);
		...
		$block[5] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( $_tp ),
				),
		);
		...
		$block[14] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( $space_3_6 ),
				),
		);
		...
		$block[6] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( - $_tp, 'px', '!important' ),
				),
		);
		...
		$block[7] = array(
			...
			'prop'            =>
				array(
					'padding-top' => _publisher_width_changer_to_px( $space_1_6, 'px', '!important' ),
				),
		);
		...
		$block[8] = array(
			...
			'prop'            =>
				array(
					'margin-bottom' => _publisher_width_changer_to_px( $space_1_6 ),
				),
		);
		...
		if ( isset( $_check[ $style ] ) ) {
			$block[16] = array(
				...
				'prop'            =>
					array(
						'margin-bottom' => _publisher_width_changer_to_px( $_check[ $style ], 'px', '!important' ),
					),
			);
		} else {
			$block[16] = array(
				...
				'prop'            =>
					array(
						'margin-bottom' => _publisher_width_changer_to_px( $space_3_6, 'px', '!important' ),
					),
			);
		}
		...
		if ( isset( $_check[ $style ] ) ) {
			...
			$block[10] = array(
				...
				'prop'            =>
					array(
						'margin-bottom' => _publisher_width_changer_to_px( $space_1_6 > 20 ? $space_1_6 - 20 : $space_1_6, 'px', '!important' ),
					),
			);
		}
		...
		$block[11] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( $space ),
				),
		);
		...
		$block[12] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( - 1 * $space ),
				),
		);
		...
		$block[13] = array(
			...
			'prop'            =>
				array(
					'padding-top'    => _publisher_width_changer_to_px( $space_1_6 ),
					'padding-bottom' => _publisher_width_changer_to_px( $space ),
					'margin-bottom'  => _publisher_width_changer_to_px( - 1 * $space_1_6 ),
				),
		);
		...
		$block[15] = array(
			...
			'prop'            =>
				array(
					'padding-top'    => _publisher_width_changer_to_px( $space_3_6 ),
					'padding-bottom' => _publisher_width_changer_to_px( $space_3_6 ),
					'margin-bottom'  => _publisher_width_changer_to_px( $space_3_6 ),
				),
		);
		...
		$block[17] = array(
			...
			'prop'            =>
				array(
					'margin-bottom' => _publisher_width_changer_to_px( $heading_bottom ),
				),
		);
		...
		$block[20] = array(
			...
			'prop'            =>
				array(
					'margin-top' => _publisher_width_changer_to_px( $space_1_6 ),
				),
		);
		...
		//
		{
			...
			$block[23] = array(
				...
				'prop'            =>
					array(
						'margin-bottom' => _publisher_width_changer_to_px( $space ) . '!important',
					),
			);
