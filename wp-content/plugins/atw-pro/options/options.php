...
class atw_Admin extends Plugin_Admin_Class_0_2 {
    ...
    function settings($key = null){
        ...
        $conditions = array(
            array(
                'label'     => sprintf(__('Name', $this->hook), 1),
                'id'        => array('condition', 0, 'name'),
                'type'      => 'text',
                'attr'      => array('size' => 30),
            ),
            array(
                'label'     => sprintf(__('Code', $this->hook), 1),
    ...
    function validate_input($input)
    {
        ...
        $input = apply_filters($this->hook . '_validate_input', $input);
        return $input;
    }
