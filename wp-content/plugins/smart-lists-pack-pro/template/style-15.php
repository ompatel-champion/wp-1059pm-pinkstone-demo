<?php
/**
 * The template for smart list style 15
 *
 * @var $smart_list
 *
 * @author     BetterStudio
...
if ( isset( $smart_list['before'] ) ) {
	echo '<span class="bs-smart-list-start bssl-before-style-15"></span>';
}

?>
	<div class="bs-smart-list bssl-style-15 bssl-t1 bssl-s15">
			...
			<div class="bssl-items bs-slider-slider">
				...
				foreach ( $smart_list['items'] as $item ) {
					...
					<div class="bssl-item bs-slider-item">
						...
						<h2 class="bssl-item-title heading-typo bssl-count-type-of">
						<span class="bssl-count"><b><?php echo $counter < 10 ? number_format_i18n( '0' ) . number_format_i18n( $counter ) : number_format_i18n( $counter ); ?></b>
							of <?php echo $smart_list['items-count']; ?></span>
							<?php echo $item['title']; ?>
						</h2>
						<?php
						...
						bssl_show_ad_location( 'bssl_style_15' );
