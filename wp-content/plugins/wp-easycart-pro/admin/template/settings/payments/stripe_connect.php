<div class="ec_admin_stripe_row">
    <div class="ec_admin_slider_row">
        ...
        <h3><?php _e( 'Stripe', 'wp-easycart-pro' ); ?></h3>
        <div class="ec_admin_slider_row_description">
            <div style="float:left; width:100%; margin-bottom:15px;">
                ...
                <br />
                <a href="<?php echo wp_easycart_admin( )->available_url; ?>/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=production' ); ?>&env=production"><?php _e( 'Switch Production Account', 'wp-easycart-pro' ); ?></a>
                <?php }?>
                <?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) != '' ){ ?>
                <br />
                <a href="<?php echo wp_easycart_admin( )->available_url; ?>/connect/?step=start&redirect=<?php echo urlencode( admin_url( ) . '?ec_admin_form_action=stripe_onboard&env=sandbox' ); ?>&env=sandbox"><?php _e( 'Switch Sandbox Account', 'wp-easycart-pro' ); ?></a>
                <?php }?>
            </div>
            ...
            <div class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important;">
                ...
                <select name="ec_option_stripe_enable_apple_pay" id="ec_option_stripe_enable_apple_pay" onchange="ec_admin_save_stripe_connect_options( );">
                    <option value="1" <?php if( get_option('ec_option_stripe_enable_apple_pay' ) ) echo ' selected'; ?>>Yes Enable</option>
                    <option value="0" <?php if( !get_option('ec_option_stripe_enable_apple_pay' ) ) echo ' selected'; ?>>Disable</option>
                </select>
            </div>
            <div id="stripe_use_ideal" class="ec_admin_settings_input ec_admin_settings_third_party_section ec_admin_settings_show" style="padding:0px !important; font-size:12px;<?php if( get_option( 'ec_option_stripe_currency' ) != 'EUR' ){ echo ' display:none;'; } ?>">
                <label style="float:left; width:100%;"><?php _e( 'Enable iDEAL (the most popular payment method in the Netherlands)', 'wp-easycart-pro' ); ?></label>
        ...
        <?php if( get_option( 'ec_option_stripe_connect_sandbox_access_token' ) != '' || get_option( 'ec_option_stripe_connect_production_access_token' ) != '' ){ ?>
        <div class="ec_admin_webhook"><strong>Webhook URL:</strong> <a href="#" onclick="ec_admin_copy_stripe_webhook( ); return false;"><?php _e( 'Copy Webhook to Clipboard', 'wp-easycart-pro' ); ?></a></div>
        ...
        <div class="ec_admin_webhook"><strong><?php _e( 'To Do', 'wp-easycart-pro' ); ?>:</strong> <?php _e( 'You must add the Webhook URL to your Stripe account for best results.', 'wp-easycart-pro' ); ?> <a href="http://docs.wpeasycart.com/wp-easycart-administrative-console-guide/?section=stripe" target="_blank"><?php _e( 'Click Here to Learn More', 'wp-easycart-pro' ); ?></a></div>
     	<?php }?>
    </div>
</div>