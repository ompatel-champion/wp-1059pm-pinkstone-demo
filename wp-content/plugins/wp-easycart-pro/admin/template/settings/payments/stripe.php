<div class="ec_admin_settings_input ec_admin_settings_live_payment_section ec_admin_settings_<?php if( get_option('ec_option_payment_process_method') == "stripe" ){ ?>show<?php }else{?>hide<?php }?>" id="stripe">
    ...
    <div>
    	...
    	<select name="ec_option_stripe_currency" id="ec_option_stripe_currency">
    ...
    <div id="stripe_use_ideal" class="ec_admin_settings_input ec_admin_settings_advanced_payment_section ec_admin_settings_show" style="padding:0px !important; font-size:12px;<?php if( get_option( 'ec_option_stripe_currency' ) != 'EUR' ){ echo ' display:none;'; } ?>">
        ...
        <select name="ec_option_stripe_enable_ideal" id="ec_option_stripe_enable_ideal">
    ...
    <div class="ec_admin_settings_notice">
        ...
        <br /><br />
        <strong><?php _e( 'Stripe Webhook URL', 'wp-easycart-pro' ); ?>:</strong> <?php echo plugins_url( EC_PLUGIN_DIRECTORY . "/inc/scripts/stripe_webhook.php" ); ?>
        <br /><br />
    </div>
