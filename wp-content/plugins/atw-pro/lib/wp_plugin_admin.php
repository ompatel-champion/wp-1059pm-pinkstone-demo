...
//            $output .= $this->plugin_donate();
        ...
        function plugin_support() {
            $content = '<ul>';
            $content .= '<li><a href="' . ATW_URL . '/documentation/" target="_blank">' . __('Documentation', $this->hook) . '</a></li>';
            $content .= '<li><a href="' . $this->credits['forums_url'] . '">' . __('Ask for help', $this->hook) . '</a></li>';
            $content .= '</ul>';

            return $this->postbox(__('Support', $this->hook), $content, $this->hook.'support');
        }
