...
function _better_ads_options_advanced( $fields ) {
	...
	$roles = better_ads_user_roles();
	unset( $roles['administrator'] );

	$fields['roles'] = array(
		'name'     => __( 'User access to edit options', 'better-studio' ),
		'desc'     => __( 'Determine which user roles are able to edit the plugin options.', 'better-studio' ),
		'id'       => 'roles',
		'multiple' => true,
		'type'     => 'select',
		'options'  => $roles,
