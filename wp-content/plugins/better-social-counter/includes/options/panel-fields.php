...
$fields['youtube_username']     = array(
	'name' => __( 'Youtube ID (Channel or User ID)', 'better-studio' ),
	'id'   => 'youtube_username',
	'type' => 'text',
);
...
$fields['youtube_type']         = array(
	'name'    => __( 'Youtube Channel or User Profile?', 'better-studio' ),
	'desc'    => __( 'Better Social Counter detects the type of your link/ID by default but if there was any problem in detection you can chose the type manualy using this field. Please report it if there is any detection.', 'better-studio' ),
	'id'      => 'youtube_type',
	'type'    => 'select',
	'options' => array(
		'auto'    => __( 'Auto Detect', 'better-studio' ),
		'channel' => __( 'Youtube Channel', 'better-studio' ),
		'user'    => __( 'Youtube User Profile', 'better-studio' ),
	)
);
...
//
$fields[]                      = array(
	'name' => __( 'Aparat', 'better-studio' ),
	'id'   => 'aparat_tab',
	'type' => 'tab',
	'icon' => 'bsfi-aparat'
);
$fields['aparat_username']     = array(
	'name' => __( 'Aparat Username', 'better-studio' ),
	'id'   => 'aparat_username',
	'type' => 'text',
);
$fields['aparat_show_counter'] = array(
	'name' => __( 'Show Subscribers Count?', 'better-studio' ),
	'id'   => 'aparat_show_counter',
	'desc' => __( 'Show/hide count in the widgets.', 'better-studio' ),
	'type' => 'switch',
);
$fields['aparat_count']        = array(
	'name'    => __( 'Fake Subscribers Count', 'better-studio' ),
	'id'      => 'aparat_count',
	'desc'    => __( 'Set the fake count if you want.', 'better-studio' ),
	'type'    => 'text',
...
$fields['aparat_name']         = array(
	'name' => __( 'Name', 'better-studio' ),
	'id'   => 'aparat_name',
	'type' => 'text',
);
$fields['aparat_title']        = array(
	'name' => __( 'Text Below The Number', 'better-studio' ),
	'id'   => 'aparat_title',
	'type' => 'text',
);
$fields['aparat_button']       = array(
	'name' => __( 'Button Text', 'better-studio' ),
	'id'   => 'aparat_button',
	'type' => 'text',
);
$fields['aparat_title_join']   = array(
	'name' => __( 'Join Text', 'better-studio' ),
	'id'   => 'aparat_title_join',
	'type' => 'text',
);
