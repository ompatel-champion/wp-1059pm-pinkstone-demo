<?php
/**
 * The template for smart list style 4
 *
 * @var $smart_list
 *
 * @author     BetterStudio
...
if ( isset( $smart_list['before'] ) ) {
	echo '<span class="bs-smart-list-start bssl-before-style-4"></span>';
}

?>
	<div class="bs-smart-list bssl-style-4 bssl-t1 bssl-s4">
		<div class="bssl-inner">
				...
				foreach ( $smart_list['items'] as $item ) {
					...
					<div class="bssl-item bs-slider-item clearfix">
						...
						<h2 class="bssl-item-title heading-typo bssl-count-type-badge">
							<span class="bssl-count bssl-outline"><?php echo number_format_i18n( $counter ); ?></span>
							<?php echo $item['title']; ?>
						</h2>
						<?php
			...
			<div class="bssl-control-nav clearfix"></div>
