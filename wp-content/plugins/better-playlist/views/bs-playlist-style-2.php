...
$type = $attrs['shortcode-id'] === 'bs-youtube-playlist-2' ? 'youtube' : 'vimeo';
...
?> class="bsp-wrapper <?php echo isset( $attrs['class'] ) ? esc_attr( $attrs['class'] ) : '' ?>  layout-<?php echo $layout; ?>">
	<?php
