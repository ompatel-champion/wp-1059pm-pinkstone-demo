<?php
/**
 * The template for smart list style 19
 *
 * @var $smart_list
 *
 * @author     BetterStudio
...
if ( isset( $smart_list['before'] ) ) {
	echo '<span class="bs-smart-list-start bssl-before-style-19"></span>';
}

?>
	<div class="bs-smart-list bssl-style-19 bssl-t1 bssl-s19">
