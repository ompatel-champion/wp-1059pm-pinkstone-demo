<div class="ec_admin_square_row">
    <div class="ec_admin_slider_row">
        ...
        <h3><?php _e( 'Square', 'wp-easycart-pro' ); ?></h3>
        <div class="ec_admin_slider_row_description">
            ...
            <?php if( get_option( 'ec_option_payment_process_method' ) == 'square' ){ ?>
                <a href="admin.php?page=wp-easycart-settings&subpage=cart-importer&ec_action=import-square-products" target="_blank"><?php _e( 'Import Products From SquareUp', 'wp-easycart-pro' ); ?></a>
