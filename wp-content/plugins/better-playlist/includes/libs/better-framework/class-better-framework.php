	...
	public function admin_enqueue_scripts() {
		...
		$better_framework_loc = array(
			...
			'on_error' => array(
				...
				'display_error'   => '<div class="bs-pages-error-section"><a href="#" class="btn bs-pages-error-copy" data-copied="' . esc_attr__( 'Copied !', 'better-studio' ) . '"><i class="fa fa-files-o" aria-hidden="true"></i> ' . __( 'Copy', 'better-studio' ) . '</a>  <textarea> ' . __( 'Error', 'better-studio' ) . ':  %ERROR_CODE% %ERROR_MSG% </textarea></div>',
