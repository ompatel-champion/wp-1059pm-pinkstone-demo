<div class="wep-container">
	...
	<ul class="wep-providers">

		<li class="upload">
			<a href="#" data-provider="upload">
				<i class="fa fa-upload"></i>

				<?php _e( 'Upload', 'wp-embedder-pack' ) ?>
			</a>
		</li>

		<li class="custom-url">
			<a href="#" data-provider="custom_url">
				<i class="fa fa-link"></i>

				<?php _e( 'Custom URL', 'wp-embedder-pack' ) ?>
			</a>
		</li>

		<li class="google-drive">
			<a href="#" data-provider="google" class="<?php echo wep_google_drive_api() ? '': ' disabled'  ?>">
			<span class="google-drive-icon icon">
				...
				<?php _e( 'Google Drive', 'wp-embedder-pack' ) ?>
			</a>
		</li>

		<li class="dropbox">
			<a href="#" data-provider="dropbox" class="<?php echo wep_dropbox_api() ? '': ' disabled'  ?>">
				<i class="fa fa-dropbox"></i>

				<?php _e( 'Dropbox', 'wp-embedder-pack' ) ?>
			</a>
		</li>
	</ul>
</div>
