<?php
/**
 * The template for smart list style 14
 *
 * @var $smart_list
 *
 * @author     BetterStudio
...
if ( isset( $smart_list['before'] ) ) {
	echo '<span class="bs-smart-list-start bssl-before-style-14"></span>';
}

?>
	<div class="bs-smart-list bssl-style-14 bssl-t1 bssl-s14">

		<div class="bssl-inner">

			<div class="bssl-control-nav full-row-both-side bssl-top">
			...
			<div class="bssl-items">
				...
				<div class="bssl-item bs-slider-item">
					...
					bssl_show_ad_location( 'bssl_style_14' );
			...
			<div class="bssl-control-nav bssl-bottom">
				<a rel="prev" class="bssl-nav-btn-big prev" href="<?php echo $prev; ?>">
					<i class="fa fa-angle-<?php echo is_rtl() ? 'right' : 'left'; ?>"
					   aria-hidden="true"></i> <?php echo BS_Smart_Lists_Pack_Pro::get_option( 'trans_page_prev' ); ?>
				</a>
