...
if ( ! function_exists( 'bsp_get_google_api_key' ) ) {
	 ...
	 * @return array|string
	 */
	function bsp_get_google_api_key( $return_array = false ) {

		$keys = [
			'AIzaSyAyv62tfTcQpfWZT7vc8APIy1gjIo727Ts', // n1
			'AIzaSyAe_LtkiFUe6tXc-GmQ_pd9bBSB69Ip-f4', // n3
			'AIzaSyDxWftWFYn_qNYvxgysiam6Ccor8c28sFI' // n2
		];

		// Remove the limited key from the other keys
		if ( $return_array ) {
